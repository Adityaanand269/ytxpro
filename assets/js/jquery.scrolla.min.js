!function(i) {
    ...
    t = {
        ...
        animate: function(t, a) {
            ...
            i.each(t, function() {
                ...
                c && (m += c,
                o -= c),
                4 === a.animateCssVersion && (t = "animated",
                s = "" + s),
                i(this).css({
                ...
                o >= e && m <= n ? (i(this).css("visibility", "visible"),
                i(this).addClass(s),
                i(this).addClass(t)) : !1 === a.once && (i(this).css("visibility", "hidden"),
    ...
    jQuery.fn.scrolla = function(a) {
        ...
        !1 === a.mobile && /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
            return !1;
        t.init(this, a)
    }
}(jQuery);
